        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" style={{ textAlign: "justify" }}>
              ...
              <b className="purple">Web Development and Mobile Development </b>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/Karankhatik"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/Karankachhwah"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/karan-khatik/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/karankachhwah/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
